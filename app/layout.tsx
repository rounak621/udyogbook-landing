...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    'Hinglish billing app',
    'Maya AI billing',
    'voice invoice India',
    'CA collaboration software',
    'party ledger software',
    'purchase bill software India',
    'GSTR filing software',
    'small business accounting India',
    'udyog billing',
    'udyogbook',
    'bill banao app',
    'GST bill kaise banaye',
    'online GST invoice generator free',
    'best billing software India 2026',
    'WhatsApp invoice sharing',
    'rental billing software India',
    'equipment rental software India',
  ],
