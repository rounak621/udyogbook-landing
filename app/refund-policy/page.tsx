      ...
      <main style={{ paddingTop: 68, background: '#fff', minHeight: '100vh' }}>
        ...
        <section style={{ padding: 'clamp(48px,6vw,80px) var(--section-px)' }}>
          <div style={{ maxWidth: 780, margin: '0 auto' }}>
            ...
            {[
              { title: '1. No Refund Policy', content: 'All subscription payments made to Udyog (UDYOG TECHNOLOGIES) are non-refundable. Once a payment has been processed for a subscription plan — whether monthly or annual — we do not provide refunds, credits, or pro-rated amounts for any reason, including but not limited to: unused subscription period, accidental purchase, dissatisfaction with the service, or discontinuation of use.' },
              ...
              { title: '7. Contact Us', content: 'If you have questions about this Refund Policy or believe you qualify for an exception, please contact us at contact@udyogbook.in or call +91 70219 22933. Our team is available Monday to Saturday, 9am to 7pm IST.' },
            ].map(section => (
