        ...
        <section style={{ padding: 'clamp(48px,6vw,80px) var(--section-px)' }}>
          <div style={{ maxWidth: 780, margin: '0 auto' }}>
            ...
            {[
              ...
              { title: '7. Contact Us', content: 'If you have questions about this Refund Policy or believe you qualify for an exception, please contact us at contact@udyogbook.in or call +91 79774 22531. Our team is available Monday to Saturday, 9am to 7pm IST.' },
            ].map(section => (
