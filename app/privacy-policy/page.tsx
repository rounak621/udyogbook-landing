        ...
        <section style={{ padding: 'clamp(48px,6vw,80px) var(--section-px)' }}>
          <div style={{ maxWidth: 780, margin: '0 auto' }}>
            {[
              ...
              { title: '8. Contact Us', content: 'If you have questions about this Privacy Policy, please contact us at contact@udyogbook.in or call +91 70219 22933. Our office is located in Mumbai, Maharashtra, India.' },
            ].map(section => (
