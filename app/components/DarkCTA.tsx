      ...
      <div className="dcta-inner" ref={ref}>
        <div className={`dcta-left fade-up${visible ? ' visible' : ''}`}>
          ...
          <div className="dcta-btns">
            ...
            <a href="https://wa.me/917021922933" target="_blank" rel="noopener noreferrer" style={{ background: '#25D366', color: '#fff', border: 'none', padding: '12px 24px', borderRadius: '10px', fontWeight: 700, fontSize: '15px', textDecoration: 'none', display: 'inline-flex', alignItems: 'center' }}>
          ...
          <p className="dcta-fine">
            ...
            <span style={{ color: 'rgba(255,255,255,0.3)', display: 'block', marginTop: '4px' }}>
              Or call us: <a href="tel:+917021922933" style={{ color: 'inherit', textDecoration: 'none' }}>+91 70219 22933</a>
            </span>
          </p>
        </div>
